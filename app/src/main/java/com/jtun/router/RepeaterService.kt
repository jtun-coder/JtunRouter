...
import com.jtun.router.net.MacAddressCompat
import com.jtun.router.net.MacAddressCompat.Companion.toLong
import com.jtun.router.net.monitor.TetherTimeoutMonitor
import com.jtun.router.net.wifi.SoftApConfigurationCompat
import com.jtun.router.net.wifi.VendorElements
import com.jtun.router.net.wifi.WifiP2pManagerHelper
import com.jtun.router.net.wifi.WifiP2pManagerHelper.deletePersistentGroup
import com.jtun.router.net.wifi.WifiP2pManagerHelper.requestConnectionInfo
import com.jtun.router.net.wifi.WifiP2pManagerHelper.requestDeviceAddress
import com.jtun.router.net.wifi.WifiP2pManagerHelper.requestGroupInfo
import com.jtun.router.net.wifi.WifiP2pManagerHelper.requestP2pState
import com.jtun.router.net.wifi.WifiP2pManagerHelper.requestPersistentGroupInfo
import com.jtun.router.net.wifi.WifiP2pManagerHelper.setVendorElements
import com.jtun.router.net.wifi.WifiP2pManagerHelper.setWifiP2pChannels
import com.jtun.router.net.wifi.WifiP2pManagerHelper.startWps
import com.jtun.router.net.wifi.WifiSsidCompat
import com.jtun.router.root.RepeaterCommands
import com.jtun.router.root.RootManager
import com.jtun.router.util.*

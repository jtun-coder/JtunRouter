package com.jtun.router.net.wifi
...
import com.jtun.router.net.wifi.SoftApConfigurationCompat.Companion.requireSingleBand
import com.jtun.router.net.wifi.SoftApConfigurationCompat.Companion.setChannel
import com.jtun.router.net.wifi.WifiSsidCompat.Companion.toCompat
import com.jtun.router.util.ConstantLookup
import com.jtun.router.util.UnblockCentral
...
data class SoftApConfigurationCompat(
     ...
     */
    var channels: SparseIntArray = SparseIntArray(1).apply { append(BAND_2GHZ, 1) },
    var securityType: Int = SoftApConfiguration.SECURITY_TYPE_OPEN,
    @TargetApi(30)
    var maxNumberOfClients: Int = 0,
    var isAutoShutdownEnabled: Boolean = false,

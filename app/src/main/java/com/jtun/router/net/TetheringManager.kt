...
import com.jtun.router.root.StartTethering
import com.jtun.router.root.StopTethering
...
import com.jtun.router.util.callSuper
import com.jtun.router.util.ensureReceiverUnregistered
import com.jtun.router.util.getRootCause
import com.jtun.router.util.matches
import com.jtun.router.util.matches1
        ...
        if (Build.VERSION.SDK_INT >= 30) try {
            ...
            if (e.targetException is SecurityException) GlobalScope.launch(Dispatchers.Unconfined) {
                val result = try {
                    ...
                    RootManager.use {
                        it.execute(com.jtun.router.root.StartTetheringLegacy(

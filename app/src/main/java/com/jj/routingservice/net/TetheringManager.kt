...
import com.jj.routingservice.root.StartTethering
import com.jj.routingservice.root.StopTethering
...
import com.jj.routingservice.util.callSuper
import com.jj.routingservice.util.ensureReceiverUnregistered
import com.jj.routingservice.util.getRootCause
import com.jj.routingservice.util.matches
import com.jj.routingservice.util.matches1
        ...
        if (Build.VERSION.SDK_INT >= 30) try {
            ...
            if (e.targetException is SecurityException) GlobalScope.launch(Dispatchers.Unconfined) {
                val result = try {
                    ...
                    RootManager.use {
                        it.execute(com.jj.routingservice.root.StartTetheringLegacy(

...
public class SmsManager {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    if(smsConversation == null){
                        com.jj.routingservice.sms.Sms sms = new com.jj.routingservice.sms.Sms(id,address,person,body,data,type,read);
     ...
     * @return 短信列表
     */
    public static List<com.jj.routingservice.sms.Sms> getAddressSms(Context context,String phoneNum){
        List<com.jj.routingservice.sms.Sms> listSms = new ArrayList<>();
        ContentResolver contentResolver = context.getContentResolver();
        Uri uri = Uri.parse("content://sms");

...
import com.jj.routingservice.net.MacAddressCompat
import com.jj.routingservice.net.MacAddressCompat.Companion.toLong
import com.jj.routingservice.net.monitor.TetherTimeoutMonitor
import com.jj.routingservice.net.wifi.SoftApConfigurationCompat
import com.jj.routingservice.net.wifi.VendorElements
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.deletePersistentGroup
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.requestConnectionInfo
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.requestDeviceAddress
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.requestGroupInfo
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.requestP2pState
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.requestPersistentGroupInfo
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.setVendorElements
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.setWifiP2pChannels
import com.jj.routingservice.net.wifi.WifiP2pManagerHelper.startWps
import com.jj.routingservice.net.wifi.WifiSsidCompat
import com.jj.routingservice.root.RepeaterCommands
import com.jj.routingservice.root.RootManager
import com.jj.routingservice.util.*
